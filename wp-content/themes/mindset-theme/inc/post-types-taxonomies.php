...
$labels = array(
    ...
    'new_item'              => __( 'New Services', 'mindset-theme' ),
    'edit_item'             => __( 'Edit Services', 'mindset-theme' ),
    'view_item'             => __( 'View Services', 'mindset-theme'  ),
    ...
    'item_link'             => __( 'Services link.', 'mindset-theme' ),
    'item_link_description' => __( 'A link to a testimonial.', 'mindset-theme' ),
);
...
$args = array(
    ...
    'supports'           => array( 'title', 'editor' ),
    'template'           => array( array( 'core/text' ) ),
    'template_lock'      => 'all'
);
